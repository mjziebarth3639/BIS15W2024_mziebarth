...
deserts %>% 
  ...
  ggplot(aes(x=species, y=weight, fill=plot_type))+
...
#it has gone down over the years
```
...
deserts %>% 
  ...
  ggplot(aes(x=weight, y=hindfoot_length, color=sex, na.rm=T))+
  geom_jitter(na.rm=T)
```
...
deserts %>% 
  ...
  labs(title="Number of Species by Sex", 
       x="Species",
