...
Small animals sleep longer on average compared to large animals.
```{r}
...
The Little brown bat sleeps the most out of the entire dataframe.
```{r}
sleep_most <- filter(sleep, sleep_total>=18)
sleep_most
```
