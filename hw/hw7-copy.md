...
MY FIRST HW UPLOAD WAS MISSNG SOME OF MY DATA, SO I'M RE-UPLOADING THIS, SORRY IT'S LATE
## Instructions
...
```r
amniota <- read.csv("data/amniota.csv", na = c("-999.00000", "-999.0000", "-999.000", "-999.00", "-999.0", "-999")) %>% clean_names()
```
